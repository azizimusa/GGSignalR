...
public class MainActivity extends AppCompatActivity {
    ...
    public void connect() {
        ...
        String serverUrl = "http://gemma.peridotec.com.my/signalr"; // connect to signalr server
        ...
        hubProxy = hubConnection.createHubProxy("GemmaHub"); // web api  necessary method name
